...
<!-- Range Slider CSS -->
<link rel="stylesheet"
	href="resources/css/components/ion.rangeslider.css" type="text/css" />
					...
					<div class="form-widget">
						...
						<div class="row">
							<div class="col-lg-6">
								...
								<c:forEach var="c" items="${c_update }">
									<form:form enctype="multipart/form-data"
										modelAttribute="uploadFile" action="prtupdate" method="post">
										...
										<!-- etc -->
										<div class="col-12 form-group">
											<label>상품 (현재 상품 : ${c.etc })</label> <select
												class="form-control required" name="etc" value="${c.etc }">
										...
										<!-- 명소명 -->
										<div class="col-12 form-group">
											<label>명소명</label> <input type="text" name="name"
												class="form-control required" value="${c.name }">
										...
										<div class="col-12 form-group">
											<label>지역1 (현재 지역1 : ${c.loc1 })</label> <select
												class="form-control required" name="loc1"
										...
										<div class="col-12 form-group">
											<label>지역2 (현재 지역2 : ${c.loc2 })</label> <select
												class="form-control required" name="loc2" id="good">
										...
										<div class="col-12 form-group">
											...
											<!-- 사진 -->
											<div class="col-12 form-group">
												<label>사진올리기</label><br> <input type="file" name="file"
													id="freelance-quote-sample" data-show-preview="true"
													multiple="multiple"><br> <label>현재 파일
													: ${c.images }</label>
											</div>
											...
											<div class="col-12 form-group">
												<label>제목</label> <input type="text" name="subject"
													class="form-control required" value="${c.subject }">
											</div>

											<!-- 내용 -->
											<div class="col-12 form-group">
												<label>내용</label>
												<textarea name="contents" class="form-control" cols="50"
													rows="30" value="${c.contents }">${c.contents }</textarea>
											</div>
