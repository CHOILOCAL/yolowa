						...
						<div class="card rounded-sm dark" style="background: linear-gradient(rgba(0,0,0,.6), rgba(0,0,0,.3)), url('') no-repeat center center / cover; padding: 60px 50px; border: 12px solid #FFF">
							<div class="card-body">
								<div class="d-flex justify-content-between">
									<h2 class="card-title text-white font-body">아이디 찾기!</h2>
								</div>
...
<i class="icon-warning-sign"></i><strong>Warning!</strong>이름과 생년월일을 확인해주세요. </div>
									...
									<form action="findid" role="form" method="post" class="mb-0" id="frm">
										...
										<input type="text" name="widget-subscribe-form-email" id="name" class="form-control required not-dark" placeholder="이름을 입력해주세요">
										<label for="widget-subscribe-form-email">생년월일 <span></span></label>
										<input type="text" name="widget-subscribe-form-email" id="birth" class="form-control required not-dark" placeholder="생년월일 ex)20190419">
									<br>	<center><a href="#" class="button button-xlarge button-dark button-rounded tright" id="btn_login">아이디 찾기<i class="icon-circle-arrow-right"></i></a>
