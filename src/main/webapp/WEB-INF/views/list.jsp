...
<!-- Document Title
	============================================= -->
<title>Review - List | Canvas</title>
	...
	<div id="wrapper" class="clearfix">
		...
		<section id="page-title">
			...
			<div class="container clearfix">
				...
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="#"><h2>Home</h2></a></li>
					<li class="breadcrumb-item active" aria-current="page">
					<a href="#" onclick="loginck()"><h2>Review Write</h2></a></li>
					<!-- @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ -->
				</ol>
			</div>
		...
		<form action="search" method="post">
			<input type="text" name="search" size="40" style="height:35px;"  id="search" placeholder="제목 검색">
			<input type="submit" class="button button-small" value="검색">
							...
							<div id="posts">
								...
								<div class="entry clearfix">
									...
									<div class="entry-image">
										<a href="resources/upload/${r.images }" data-lightbox="image"><img
											class="image_fade" src="resources/upload/${r.images }"
									...
									<div class="entry-title">
										<h2>
											<a href="blog-single.html">${r.subject }</a>
										</h2>
									</div>


									<ul class="entry-meta clearfix">
										<li><i class="icon-calendar3"></i> ${r.date }</li>
										<li><a href="#"><i class="icon-user"></i> ${r.id }</a></li>
										<li><i class="icon-comments"></i> 13 Comments</li>
									...
									<div class="entry-content">
										<p>${r.contents }</p>
										<a href='review?review_id=${r.id }' class="more-link">Read
											More</a>
									</div>
								</div>
							</div>
						...
						<div class="col_half col_last tright">
							<div class="fright clearfix">
								<a href="#"
									...
									class="social-icon si-small si-borderless si-github"> <i
									class="icon-github"></i> <i class="icon-github"></i>
